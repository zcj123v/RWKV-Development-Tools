...
#         "gsm8k_parquet_file_path_input","gsm8k_n_rollout_questions_input", "gsm8k_req_sp_token", "gsm8k_req_prefix",
#         "gsm8k_resp_sp_token", "gsm8k_resp_prefix", "gsm8k_n_save_ckpt",
#         "gsm8k_max_resp_ctx_len", "gsm8k_tiny_batch_size",
#         "gsm8k_num_rollouts", "gsm8k_train_batch_size", "gsm8k_n_save_episode",
#         "grpo_lr_init", "grpo_lr_final", "grpo_lr_warmup",
#         "grpo_accumulate_grad", "gsm8k_temperature",
#         "gsm8k_top_p", "gsm8k_presence_penalty", "gsm8k_frequency_penalty",
#         "gsm8k_penalty_decay",
#     ]
...
#             preferences.get("gsm8k_parquet_file_path_input", gr.update()),
#             preferences.get("gsm8k_n_rollout_questions_input", gr.update()),
#             preferences.get("gsm8k_req_sp_token", gr.update()),
#             preferences.get("gsm8k_req_prefix", gr.update()),
#             preferences.get("gsm8k_resp_sp_token", gr.update()),
#             preferences.get("gsm8k_resp_prefix", gr.update()),
#             preferences.get("gsm8k_n_save_ckpt", gr.update()),
#             preferences.get("gsm8k_max_resp_ctx_len", gr.update()),
#             preferences.get("gsm8k_tiny_batch_size", gr.update()),
#             preferences.get("gsm8k_num_rollouts", gr.update()),
#             preferences.get("gsm8k_train_batch_size", gr.update()),
#             preferences.get("gsm8k_n_save_episode", gr.update()),
...
#             preferences.get("gsm8k_temperature", gr.update()),
#             preferences.get("gsm8k_top_p", gr.update()),
#             preferences.get("gsm8k_presence_penalty", gr.update()),
#             preferences.get("gsm8k_frequency_penalty", gr.update()),
#             preferences.get("gsm8k_penalty_decay", gr.update()),
#             "已加载历史填写。",
#         ]
#     except FileNotFoundError:
#         return [gr.update()] * 61 + ["无历史操作记录"]
#     except Exception as e:
#         return [gr.update()] * 61 + [f"加载失败: {str(e)}"]

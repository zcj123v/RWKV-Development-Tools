...
class RWKV(nn.Module):
    def __init__(self, args_in):
        ...
        # if args.train.train_type == "state-tuning":
    ...
    def get_optim_groups(self):
        ...
        for n, p in self.named_parameters():
            ...
            #     lr_1x.add(n)
            # elif (("time_mix" in n) or ("time_maa" in n)) and (args.train.layerwise_lr > 0):
            #     if args.train.my_pile_stage == 2:
            #         lr_2x.add(n)
            #     else:
            #         lr_1x.add(n)
            # elif (("time_decay" in n) or ("time_daaaa" in n)) and (args.train.layerwise_lr > 0):
            #     if args.train.my_pile_stage == 2:
            #         lr_3x.add(n)
            #     else:
            #         lr_2x.add(n)

...
full_current_dir= os.path.dirname(os.path.abspath(__file__))




wkv6state_cuda = load(name="wkv6state",
                      sources=[f"{full_current_dir}/cuda/state_tuning/wkv6state_op.cpp", f"cuda/wkv6state_cuda.cu"],
                      verbose=True,
...
class TimeMix(nn.Module):
    ...
    def forward(self, x, last_state):
        if self.training:
            ...
            return self.forward_no_cuda(x, last_state) 
